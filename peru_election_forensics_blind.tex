...
% --- blind title block (no author, no affiliation) ---------------------------
\begin{center}
  {\large\bfseries Election Forensics in a Polarized Democracy:\\[4pt]
   Evidence from Peru's 2021 Presidential Runoff}\\[12pt]
